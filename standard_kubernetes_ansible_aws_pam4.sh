...
echo "1001 soft memlock unlimited" >> /etc/security/limits.conf
echo "1001 hard memlock unlimited" >> /etc/security/limits.conf
...
#add user 1001 for fnot-root user container
