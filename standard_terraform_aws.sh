...
curl https://releases.hashicorp.com/terraform/0.12.19/terraform_0.12.19_linux_amd64.zip > terraform_0.12.19_linux_amd64.zip && unzip terraform_0.12.19_linux_amd64.zip && sudo install terraform /usr/local/bin/
#restart
#reboot