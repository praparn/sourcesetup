...
#install cloudwatch configuration
wget https://raw.githubusercontent.com/praparn/sourcesetup/master/standard_aws_cloudwatch.sh
sudo chmod +x ./standard_aws_cloudwatch.sh
./standard_aws_cloudwatch.sh
